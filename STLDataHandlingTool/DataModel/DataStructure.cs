...
namespace DataModel
{
    public class DataStructure
    {
        ...
        public IList<int> FaultyEdges = new List<int>(); // List of faulty edges implemented by Maximilian Mews. List will be handed over to OpenGlUserControl for performance reasons
